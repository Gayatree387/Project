...
public class WBStringReadFromHyperterminal extends BasePage implements AutoConstant, Khanij_TestData{
	
	public WBStringReadFromHyperterminal(WebDriver driver)
	{
